<?php
//This REST API is used to update information(Last Active Information) of an user of VBG app.
...
$tableInDB = 'users;'
$query = "UPDATE ".$tableInDB ." SET created_at=now() WHERE username=?";
